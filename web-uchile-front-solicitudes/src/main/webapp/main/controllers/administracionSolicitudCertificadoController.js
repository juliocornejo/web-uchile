var solicitudCertificadoApp = angular.module('administracionSolicitudCertificado',[]);



solicitudCertificadoApp.controller('AdministracionSolicitudCertificadoController', [ '$scope', '$http', '$window', '$sce',
	...
	$scope.parsearAdministracionSolicitudCertificadoJson = function() {
		...
		$scope.jsonListaSolicitudCertificadoCtrl = $window.jsonListaSolicitudCertificado;
