		 ...
		 SexyLightbox = new SexyLightBox({
          ...
          'captionColor': '#FFFFFF',
	       ...
	       'color' : 'verde'
			...
			new CalendarEightysix('date_start', { 'toggler': 'date_start_cal', 'alwaysShow': 'true','alignX':'middle', 'alignY':'top','theme':'vista','disallowUserInput':'true','format': '%A %D de %B' });
			new CalendarEightysix('date_end', { 'toggler': 'date_end_cal', 'alwaysShow': 'true','alignX':'middle', 'alignY':'top','theme':'vista','disallowUserInput':'true','format': '%A %D de %B' });
		});
	</script>
  </head>
...
<a href="planes.php"><img src="sistema/inclusiones/imagenes/promocional/index_08.jpg" alt="" width="268" height="422" border="0"></a></td>
	...
	<tr>
      ...
      <input type="text" name="date_start" id="date_start" value="" style="text-align:center; margin: 0px 55px 0px 0px; border:hidden;" size="20"/><input type="text" name="date_end" id="date_end" value="" style="text-align:center;border:hidden;" size="20" /><a href="prueba.php?TB_iframe=true&width=700&height=400" onclick="this.href='prueba.php?' + '&date_start=' + $('date_start').value + '&date_end=' + $('date_end').value + '&TB_iframe=true&width=700&height=400'" rel="sexylightbox"><br /><br />PLANIFICAR!</a>
		</div>
        </td>
