...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="sistema/inclusiones/calendar-eightysix/js/compressed/mootools-1.2.4.2-more.js"></script> 
	<!-- Sexy Lightbox 2 -->
    ...
    <!-- Calendar Eightysix -->
    <script type="text/javascript" src="sistema/inclusiones/calendar-eightysix/js/compressed/calendar-eightysix-v1.0.1.js"></script> 
    <link rel="stylesheet" href="sistema/inclusiones/calendar-eightysix/css/calendar-eightysix-vista.css" type="text/css" media="screen" />
		 ...
		 SexyLightbox = new SexyLightBox({
          ...
          'captionColor': '#FFFFFF',
	       ...
	       'color' : 'verde'
			...
			new CalendarEightysix('date_start', { 'toggler': 'date_start_cal', 'alwaysShow': 'true','alignX':'middle', 'alignY':'top','theme':'vista','disallowUserInput':'true','format': '%Y-%m-%d' });
			new CalendarEightysix('date_end', { 'toggler': 'date_end_cal', 'alwaysShow': 'true','alignX':'middle', 'alignY':'top','theme':'vista','disallowUserInput':'true','format': '%Y-%m-%d' });
		});
	</script>
  </head>
...
<a href="planes.php"><img src="sistema/inclusiones/imagenes/promocional/index_08.jpg" alt="" width="268" height="422" border="0"></a></td>
	...
	<tr>
		<td width="374" height="276" rowspan="2" colspan="3">
        <div align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif;">
        <table cellpadding="0" cellspacing="0" border="0" style="margin: 30px 0px 30px 0px; color:#006600">
        	<tr>
            ...
            <tr><td><div id="date_start_cal"></div></td><td><div id="date_end_cal"></div></td></tr>
            <tr><td id="date_start_td" align="center"></td><td id="date_end_td" align="center"></td></tr>
         </table>            
      <input type="text" name="date_start" id="date_start" value="" style="text-align:center; margin: 0px 55px 0px 0px; border:hidden;" size="20"/><input type="text" name="date_end" id="date_end" value="" style="text-align:center;border:hidden;" size="20" /><a href="prueba.php?TB_iframe=true&width=700&height=400" onclick="this.href='prueba/prueba.php?' + '&start_date=' + $('date_start').value + '&end_date=' + $('date_end').value + '&dia=1&TB_iframe=true&width=700&height=400'" rel="sexylightbox"><br /><br />PLANIFICAR!</a>
		</div>
        </td>
		<!-- <td width="318" height="42" colspan="2" rowspan="2" background="sistema/inclusiones/imagenes/promocional/index_10.jpg"></td> -->
