...
public class AdministracionUsuarioImpl {

	private static final Logger objLog = Logger.getLogger(AdministracionUsuarioImpl.class);
	...
	public AdministracionUsuarioImpl(String remoteAddr, String remoteHost, String token){
